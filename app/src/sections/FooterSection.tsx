  ...
  return (
    <section className="relative w-full bg-terracotta py-20 px-6">
      ...
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="font-display text-5xl lg:text-6xl text-sand mb-6">
          Donate Sadaqah Jariyah
        </h2>

        <p className="font-serif text-xl lg:text-2xl text-sand/80 leading-relaxed mb-8 max-w-xl mx-auto">
          Sadaqah Jariyah is a continuous charity that benefits the deceased even
          after they have passed. By donating to breast cancer care & research in
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-block px-10 py-5 rounded-full bg-sacred/30 border border-sand/20 hover:bg-sacred/50 transition-all duration-500 font-display text-2xl text-sand tracking-widest text-center"
          >
            Donate from Oman
          </a>
          <a
        ...
        <div className="mt-12 pt-8 border-t border-sand/10">
          <p className="font-serif text-lg lg:text-xl text-sand/60 italic leading-relaxed">
          ...
          <p className="font-display text-xl text-sand/40 mt-3">
            — Surah Ya-Sin, Verse 12
          </p>
        </div>

        <div className="mt-12">
          <p className="font-display text-3xl text-sand/70">
